...
const TestimonialView = () => {
    const { title, testimonial, links, selectedClient,
        setSelectedClient, } = useTestimonialView()
    ...
    const { client_name, client_image, client_segment, images, stars } = testimonial[selectedClient];
