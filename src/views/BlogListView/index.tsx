    ...
    return (
        ...
        <div className={`${styles.mainContainer} `}>
            <div className={`scrollbar-hidden ${styles.blogsCardContainer}`}>
                {blogss?.length > 0 ? blogss.map((blog, index) => <BlogCard key={index} blog={blog} />) : <div className={`${styles.noBlogFound}`}>No Blog Found</div>
                }
            </div>
            <div className={`scrollbar-hidden ${styles.featuredBlogsContainer}`}>
                {fBlogss?.length > 0 ? fBlogss.map((blog, index) => <BlogFeaturedCard key={index} blog={blog} />) : <div className={`${styles.noBlogFound}`}>No Blog Found</div>}
            </div>
        </div>
